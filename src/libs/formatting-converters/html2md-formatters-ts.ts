 ...
 * @return {String}           [description]
 */
function replaceHeading({ doc }: { doc: string; dialect?: string }): string {
  return makeRegex({
    regex: headingRegex,
    doc,
 ...
 * @return {String}           [description]
 */
function replaceParagraph({ doc }: { doc: string; dialect?: string }): string {
 ...
 * @return {String}           [description]
 */
function replaceDel({ doc }: { doc: string; dialect?: string }): string {
 ...
 * @return {String}           [description]
 */
function replacePre({ doc }: { doc: string; dialect?: string }): string {
  return makeRegex({
    regex: preRegex,
    doc,
 ...
 * @return {String}           [description]
 */
function replaceCode({ doc }: { doc: string; dialect?: string }): string {
  return makeRegex({
    regex: codeRegex,
    doc,
    replaceFn: (match: any) => match[1].replace(/&#95;/g, "_"),
 ...
 * @return {String}           [description]
 */
function replaceBold({ doc }: { doc: string; dialect?: string }): string {
 ...
 * @return {String}           [description]
 */
function replaceUnderline({ doc }: { doc: string; dialect?: string }): string {
  return makeRegex({
 ...
 * @return {String}           [description]
 */
function replaceItalic({ doc }: { doc: string; dialect?: string }): string {
